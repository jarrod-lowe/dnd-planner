 ...
 * good.
 *
 * The legacy engine kept it alive by re-advertising a self-effect each turn gated
 * on a per-eval `consumed` flag. Here the effect lifetime expresses the same:
