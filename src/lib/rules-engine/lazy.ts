...
const LOADERS: Record<string, () => Promise<{ default: RuleModule }>> = {
  ...
  'class-paladin-level7': () => import('./rules/class-paladin-level7'),
  ...
  'class-paladin-oath-redemption-level7': () =>
    import('./rules/class-paladin-oath-redemption-level7'),
  ...
  'condition-incapacitated': () => import('./rules/condition-incapacitated'),
  'condition-grappled': () => import('./rules/condition-grappled'),
  'condition-restrained': () => import('./rules/condition-restrained'),
  ...
  'spell-detect-evil-and-good': () => import('./rules/detect-evil-and-good')
};
