...
export const INITIAL_EFFECTS: Record<string, EffectInstance[]> = {
  ...
  'calm-emotions-concentration-replacement': [slot(2, 2)],
  'calm-emotions-concentration-replacement-planned': [slot(2, 2)],
  ...
  'hold-person-concentration-replacement': [slot(2, 2)],
  'hold-person-concentration-replacement-planned': [slot(2, 2)],
