...
import { evaluatePlan, evaluateSheet } from '$lib/rules-engine-v2';
...
import level1 from '$lib/rules-engine-v2/rules/class-paladin-level1';
import level5 from '$lib/rules-engine-v2/rules/class-paladin-level5';
...
describe('v2 extra attack — level 5 grants the follow-up budget', () => {
