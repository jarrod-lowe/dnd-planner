...
import { evaluateSheet, endTurn } from '$lib/rules-engine';
...
describe('replace-by-identity (effect key)', () => {
...
describe('per-fact stateCombine', () => {
...
describe('endTurn — key dedupe + permanent', () => {
