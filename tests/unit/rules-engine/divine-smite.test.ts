...
import classPaladinLevel1 from '$lib/rules-engine/rules/class-paladin-level1';

/**
 * M0 spike, increment 3b — Divine Smite end to end.
 *
 * The legacy rule group was 832 lines across an unrolled L5->L1 cascade, per-level
...
describe('divine-smite — structural gate', () => {
...
describe('divine-smite — illegal-but-visible', () => {
...
describe('divine-smite — slot cascade / slider bounds (no free-use feature)', () => {
...
describe('divine-smite — paladin slots + level bounds', () => {
